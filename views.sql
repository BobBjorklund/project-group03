...
Create or replace view kidwns as select kids.*, nk.num_kids from kids join nk on kids.dam = nk.dam;
Create or replace view damwbw as select d.*, b.alpha_value from damwnk as d join birth_weight as b on d.animal_id = b.animal_id;
Create or replace view kidwbw as select k.*, b.alpha_value from kidwns as k join birth_weight as b on b.animal_id = b.animal_id;
